...
class Qun extends Base
{
    ...
    public function get_qun($id)
    {
        $key = "qun_{$id}";
        //if (!$this->mc->get($key)) {
            $res = $this->getOne(['id' => $id], ['id', 'name', 'key', 'maxopen', 'maxtouch', 'rukou', 'bg_img', 'default_img', 'tongji1', 'tongji2', 'controller', 'black_area', 'black_ip', 'black_name', 'internet_name', 'get_user', "is_ip"]);
